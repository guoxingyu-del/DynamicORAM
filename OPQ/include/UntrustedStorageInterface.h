#ifndef OPQ_UNTRUSTED_STORAGE_INTERFACE_H
#define OPQ_UNTRUSTED_STORAGE_INTERFACE_H
#include "Bucket.h"
...
public:
    ...
    virtual Block ReadSubtreeMax(int position) = 0;

    virtual void WriteSubtreeMax(int position, const Block& subtree_max) = 0;
};
